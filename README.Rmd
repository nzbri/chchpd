...
This package is only of interest and utility internally at NZBRI and hence can't 
 be made available via CRAN. Instead, it is hosted in an online repository on 
 Github at https://github.com/nzbri/chchpd.
...
The list of release names is here: https://github.com/nzbri/chchpd/releases
